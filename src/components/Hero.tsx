  ...
  return (
    <section className="relative pt-28 pb-20 md:pt-36 md:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 right-0 w-full md:w-1/2 h-full bg-emerald-50 -skew-y-6 translate-y-24 transform-gpu"></div>
      </div>
      
      <div className="container relative">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="max-w-lg animate-fade-up">
            <div className="mb-6 inline-flex items-center rounded-full bg-emerald-100 px-3 py-1 text-sm font-medium text-emerald-600">
              <span>Medical Revenue Cycle Management</span>
            </div>
            
            <h1 className="mb-6 font-bold leading-tight text-navy-900">
              Maximizing Your <br />
              <span className="text-emerald-600">Healthcare Revenue</span>
            </h1>
          ...
          <div className="relative flex justify-center animate-fade-in">
            <div className="relative w-full max-w-md aspect-[4/3] rounded-2xl overflow-hidden shadow-intense">
              <div className="absolute inset-0 bg-gradient-to-tr from-emerald-500/90 to-emerald-400/80"></div>
              <img 
